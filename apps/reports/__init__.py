...
from common.api import register_links, register_menu, can_add, can_edit, user_is_staff
...
report_edit = {'text': _('edit report'),
        ...
        'hide_text': True,
        'famfam': 'pencil', 'condition': lambda o,c: can_edit(o,c) or user_is_staff(o,c)}
